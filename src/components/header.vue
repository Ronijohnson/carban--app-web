<template>
  <div class="flex-view flex-direction-row justify-content-b mobile-static-nav">
    <div class="flex-view flex-direction-row">
      ...
      <div class="hamburger">
        <i class="fa fa-bars" aria-hidden="true" @click="myfunction()"></i>
      </div>
